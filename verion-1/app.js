...
document.title = `FOOR Logistics — ${designNames[design]} | US Trucking`;
...
const approvedCopy = window.FOOR_CONTENT;
const services = {
  ftl: { title: 'Truckload services', description: approvedCopy.services[0][1], features: ['Heavy Haul & Specialized', approvedCopy.services[2][1]] },
  ltl: { title: 'LTL services', description: approvedCopy.services[1][1], features: [] },
  drayage: { title: 'Drayage/Intermodal', description: approvedCopy.services[3][1], features: [] },
  heavy: { title: 'Heavy Haul & Specialized', description: approvedCopy.services[2][1], features: [] }
};
...
const capabilities = {
  ftl: { kicker: 'TRUCKLOAD SERVICES', title: services.ftl.title, description: services.ftl.description, action: 'Request Quote', caption: '01 / TRUCKLOAD SERVICES' },
  ltl: { kicker: 'LTL SERVICES', title: services.ltl.title, description: services.ltl.description, action: 'Request Quote', caption: '02 / LTL SERVICES' },
  drayage: { kicker: 'DRAYAGE / INTERMODAL', title: services.drayage.title, description: services.drayage.description, action: 'Request Quote', caption: '03 / DRAYAGE / INTERMODAL' }
};
...
document.querySelector('#download-request').addEventListener('click', () => {
  ...
  link.href = url; link.download = 'foor-freight-request.txt';
